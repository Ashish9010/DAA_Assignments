...
int main(){
	...
	print("Array A is: ", matrix_A, 0, 0, ROW_1 - 1, COL_1 - 1);
	print("Array B is: ", matrix_B, 0, 0, ROW_2 - 1, COL_2 - 1);

	vector<vector<int> > result_matrix(
		multiply_matrix(matrix_A, matrix_B));

	print("Result of matrix_A X matrix_B", result_matrix, 0, 0, ROW_1 - 1,
		COL_2 - 1);
}
